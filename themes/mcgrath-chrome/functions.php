...
function mcg_customize( $wp_customize ) {
	...
	$fields = array(
		...
		'mcg_result_title'=> array( 'Result title that comes back', 'McGrath Marketing Group — SEO & AI Search, Jupiter FL' ),
		'mcg_result_snip' => array( 'Result snippet', 'SEO, AI search optimisation and web design for businesses in Jupiter and across the country.' ),
