...
<div class="gut">
	...
	<div class="split rv">
		<div>
			<h2 data-tag="&lt;h2&gt;"><?php esc_html_e( 'What is included in a website build?', 'mcgrath-chrome' ); ?></h2>
			<h3 data-tag="&lt;h3&gt;"><?php esc_html_e( 'What is on every build?', 'mcgrath-chrome' ); ?></h3>
			<ul class="checks">
			...
			<h3 data-tag="&lt;h3&gt;"><?php esc_html_e( 'What happens before the site goes live?', 'mcgrath-chrome' ); ?></h3>
			<ul class="checks">
		...
		<div>
			<h2 data-tag="&lt;h2&gt;"><?php esc_html_e( 'How do you redesign a site without losing rankings?', 'mcgrath-chrome' ); ?></h2>
			...
			<h3 data-tag="&lt;h3&gt;"><?php esc_html_e( 'What is a redirect map?', 'mcgrath-chrome' ); ?></h3>
			<ul class="checks">
	...
	<div class="split rv">
		<div>
			<h2 data-tag="&lt;h2&gt;"><?php esc_html_e( 'How should a page be laid out?', 'mcgrath-chrome' ); ?></h2>
			...
			<h3 data-tag="&lt;h3&gt;"><?php esc_html_e( 'What order should a page be read in?', 'mcgrath-chrome' ); ?></h3>
		...
		<div>
			<h2 data-tag="&lt;h2&gt;"><?php esc_html_e( 'Do I own the website when it is finished?', 'mcgrath-chrome' ); ?></h2>
			...
			<h3 data-tag="&lt;h3&gt;"><?php esc_html_e( 'What gets handed over at the end?', 'mcgrath-chrome' ); ?></h3>
			<ul class="checks">
	...
	<?php mcg_faq_block( 'webdesign', __( 'What else do people ask before a build?', 'mcgrath-chrome' ) ); ?>
