...
function envue_seo_meta() {
    return [
        ...
        'results'                   => [ 'Fleet Telematics ROI: Real Results from Real Fleets | EnVue Telematics', 'Verified results: 31% fewer accidents, 7% fuel savings, 40% dispatch efficiency. See what Geotab-powered telematics delivers for fleets like yours.' ],
        ...
        'car-advise'                => [ 'CarAdvise Fleet Maintenance Marketplace | EnVue Telematics', 'Pre-negotiated fleet maintenance rates at 20,000+ shops. CarAdvise integrated with Geotab diagnostics by EnVue Telematics.' ],
        ...
        'lifesaver-mobile'          => [ 'LifeSaver Mobile Distracted Driving Prevention | EnVue', 'Block distracting apps while drivers are in motion. LifeSaver Mobile integrated with Geotab GPS by EnVue Telematics.' ],
        'predictive-coach'          => [ 'Predictive Coach AI Driver Risk Scoring | EnVue Telematics', 'Identify which drivers are most likely to have a future accident. Predictive Coach AI powered by Geotab data from EnVue Telematics.' ],
        ...
        'moveev'                    => [ 'MoveEV Electric Fleet Management & EV Readiness | EnVue', 'Data-driven EV readiness and fleet electrification planning powered by Geotab vehicle usage data from EnVue Telematics.' ],
        ...
        'craig-safety-technologies' => [ 'Craig Safety Technologies Fire Suppression | EnVue Fleet Safety', 'Vehicle fire suppression systems for commercial fleets and heavy equipment. Craig Safety coordinated with EnVue Telematics fleet programs.' ],
        'xtract'                    => [ 'Xtract Fleet Data Reporting & Business Intelligence | EnVue', 'Custom fleet reporting and automated data delivery from Geotab telematics. Configured and supported by EnVue Telematics.' ],
