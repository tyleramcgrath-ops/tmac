...
<section class="page-hero">
  <img class="page-hero-bg" src="https://envuetelematics.com/wp-content/uploads/2026/08/connected-fleet-solutions-hero-scaled.png" alt="Connected fleet solutions with Geotab, GO Focus Plus, Bosch, Predictive Coach and Magtec" loading="eager" fetchpriority="high">
  <div class="wrap">
...
<section class="final-cta" id="demo"><div class="wrap final-grid">
  <div><span class="eyebrow eyebrow--light">Connected Fleet Solutions</span><h2>Talk to a fleet specialist.</h2></div>
  <div><p>We&rsquo;ll help you choose, implement and support the right video intelligence, collision detection, driver coaching and vehicle security solutions for your Geotab-powered fleet.</p>
  <div class="hero-actions">
    <a class="button button-primary button-lg" href="<?php echo esc_url(home_url("/get-in-touch/")); ?>">Talk to a Fleet Specialist <span>&rarr;</span></a>
