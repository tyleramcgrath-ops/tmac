...
<?php
echo envue_faq_section([
    'What are AI fleet dash cams and how do they work?' => '<p>AI fleet dash cams use computer vision to continuously analyze driver behavior and road conditions. When a risk event is detected — distracted driving, cell phone use, tailgating, harsh braking, or lane departure — the system triggers an in-cab coaching alert and uploads the event clip to the cloud for manager review. EnVue deploys AI dash cams from Lytx, Netradyne, and Samsara, integrated with Geotab GPS fleet tracking.</p>',
