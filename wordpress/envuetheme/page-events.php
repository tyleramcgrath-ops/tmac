...
<section class="page-hero">
  <img class="page-hero-bg" src="https://envuetelematics.com/wp-content/uploads/2026/06/ef33f418-bf49-49c3-858f-ee37bc0a50b0-1.jpeg" alt="Highway interchange with trucks — Fleet Solutions Delivered" loading="eager" fetchpriority="high">
  <div class="wrap">
...
<section class="final-cta" id="demo"><div class="wrap final-grid">
  <div><span class="eyebrow eyebrow--light">Meet EnVue</span><h2>Can&rsquo;t wait for the next event?</h2></div>
  <div><p>Talk to an EnVue fleet expert today about GPS tracking, AI dash cams, compliance, and the Geotab platform — and get a free assessment of your fleet&rsquo;s biggest opportunities.</p>
  <div class="hero-actions">
