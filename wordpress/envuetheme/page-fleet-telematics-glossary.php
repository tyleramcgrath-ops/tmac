...
<section class="page-hero">
  <img class="page-hero-bg" src="https://envuetelematics.com/wp-content/uploads/2026/06/smarter-fleet-management-hd-scaled.jpg" alt="Fleet management technology overview" loading="eager" fetchpriority="high">
  <div class="wrap">
...
<section class="final-cta" id="demo"><div class="wrap final-grid">
  ...
  <div class="hero-actions">
    <a class="button button-primary button-lg" href="<?php echo esc_url(home_url("/claim-your-free-15-minute-fleet-audit/")); ?>">Book a Free Demo <span>&rarr;</span></a>
