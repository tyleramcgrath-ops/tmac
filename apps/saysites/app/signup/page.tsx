...
export default async function SignUpPage({ searchParams }: { searchParams: Promise<{ idea?: string; template?: string; claim?: string }> }) {
    ...
    <>
      ...
      <main className="auth">
        <div className="auth-card">
          ...
          <SignUpForm idea={idea} template={template} claim={claim} />
