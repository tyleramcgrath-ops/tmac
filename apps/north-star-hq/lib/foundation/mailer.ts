...
export async function sendVerificationEmail(to: string, link: string): Promise<MailResult> {
  ...
  const result = await sendEmail({
    to,
    subject: 'Verify your North Star Headquarters email',
    html: `<p>Welcome to North Star Headquarters. Confirm your email to finish setting up your account:</p><p><a href="${link}">Verify email</a></p><p>Or paste this link: ${link}</p>`,
    text: `Welcome to North Star Headquarters. Verify your email: ${link}`,
  })
...
export async function sendInvitationEmail(
  ...
  const result = await sendEmail({
    to,
    subject: `${inviterName} invited you to ${orgName} on North Star Headquarters`,
    html: `<p>${safeInviter} invited you to join <strong>${safeOrg}</strong> on North Star Headquarters as ${safeRole}.</p><p><a href="${link}">Accept invitation</a></p><p>Or paste this link: ${link}</p>`,
    text: `${inviterName} invited you to join ${orgName} on North Star Headquarters as ${role}. Accept: ${link}`,
  })
