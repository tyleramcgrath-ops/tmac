// Self-serve billing decisions (Stripe). Pure logic, no Stripe SDK import
// here — kept testable and separate from lib/foundation/billing/stripe.ts
// (the actual Stripe API client). Gates ONE thing: whether this org may have
// RankForge write changes to a live site (Operator deploy, WordPress tab
// deploy, Internal Links auto-link). Audits, recommendations, diagnostics,
// and rollback are never gated — a trial ending should never strand a user
// unable to undo or even see their own site's problems.
