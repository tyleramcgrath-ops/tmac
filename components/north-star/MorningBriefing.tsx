...
export function MorningBriefing({ scenario }: { scenario: PreviewScenario }) {
  ...
  return (
    <header className="ns-fade-in">
      ...
      <h1 className="ns-serif mt-3 text-[28px] font-semibold leading-tight text-white sm:text-4xl">
        {briefing.headline}
      </h1>

      <p className="mt-3 max-w-2xl text-base leading-relaxed text-[var(--rf-muted)] sm:text-lg">
        {briefing.subline}
      </p>
