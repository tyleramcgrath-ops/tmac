...
const FAQ_ITEMS = [
  { q: 'What does an audit actually check?', a: 'A real crawl (up to 300 pages) scores four categories per page — technical, content, schema, and AI-readiness — from the fetched HTML itself: title/meta length, H1 structure, canonical tags, HTTPS, mixed content, structured data, image alt coverage, internal links, and more. Nothing is estimated from a domain name; every score traces to a specific crawled page.' },
