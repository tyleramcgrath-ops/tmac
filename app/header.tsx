  ...
  return (
    <header className={cn('flex items-center justify-between', className)}>
      ...
      <div className="flex items-center ml-auto space-x-1.5">
        <Link
          href="/jobs"
          className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold uppercase tracking-wider border border-emerald-500/40 text-emerald-400 hover:bg-emerald-500/10 transition-colors"
        >
