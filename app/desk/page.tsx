  ...
  return (
    ...
    >
      <defs>
        ...
        <clipPath id="hz-topclip">
          <ellipse cx="800" cy="600" rx="502" ry="42" />
        </clipPath>
      </defs>
      ...
      {/* gold veins running through the stone, clipped to the blade */}
      <g clipPath="url(#hz-topclip)" fill="none" stroke="rgba(206,162,92,0.14)" strokeWidth="0.9">
        <path d="M 300 588 Q 520 580 700 592 T 1080 588 L 1310 596" />
        <path d="M 340 614 Q 640 604 900 616 T 1290 610" strokeWidth="1.1" />
        <path d="M 610 578 Q 660 600 620 626" strokeWidth="0.7" stroke="rgba(232,190,116,0.16)" />
      </g>
...
/** Gold veining wandering through the black marble, foreshortened with
 *  the floor — a few real veins, not a texture wash. */
function FloorVeins() {
  return (
    <svg className="hz-veins" viewBox="0 0 1600 380" preserveAspectRatio="none" aria-hidden="true">
      <g fill="none" stroke="rgba(214,170,98,0.15)" strokeWidth="1.1">
        <path d="M -20 96 Q 210 82 388 100 T 760 92 Q 900 86 1050 104 T 1400 96 L 1640 108" />
        <path d="M -20 180 Q 260 158 520 186 T 1010 172 Q 1240 162 1470 190 L 1640 182" strokeWidth="1.4" />
        <path d="M -20 292 Q 330 258 640 300 T 1260 282 L 1640 306" strokeWidth="1.8" stroke="rgba(214,170,98,0.2)" />
        <path d="M 240 40 Q 300 130 250 220 T 320 372" strokeWidth="1" stroke="rgba(214,170,98,0.11)" />
        <path d="M 1330 30 Q 1290 140 1350 240 T 1300 376" strokeWidth="1" stroke="rgba(214,170,98,0.11)" />
        <path d="M 560 210 Q 610 224 668 214" strokeWidth="0.8" stroke="rgba(240,200,124,0.22)" />
        <path d="M 1010 300 Q 1070 316 1140 304" strokeWidth="0.8" stroke="rgba(240,200,124,0.22)" />
      </g>
    </svg>
  )
}
  ...
  return (
    <main ref={rootRef} className="hz-root" onPointerMove={onPointerMove}>
      ...
      <div className="hz-view" aria-hidden="true">
        ...
        {/* dusk clouds, drifting slow — dark above, lit amber at the horizon */}
        <div className="hz-cloud c1" />
        <div className="hz-cloud c2" />
        <div className="hz-cloud c3" />
