...
export default function AppDashboard() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      ...
      {/* Honesty banner: this is an unsaved, browser-only quick scan. Nothing
          here persists. Real, saved work lives in Projects. */}
      <div className="border-b border-yellow-500/20 bg-yellow-500/10 px-4 py-2 text-center text-xs text-yellow-200">
        Unsaved quick scan — results, WordPress details, and business inputs live only in this browser and are not saved.{' '}
        <a href="/app/projects" className="font-semibold underline">Open Projects</a> to run persistent, saved audits with deployment history.
      </div>
